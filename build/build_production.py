...
from wikirag.embedding import OllamaEmbedder
from wikirag.models import Article, BuildConfig
from wikirag.utils import configure_logging, read_json, write_json
from build.chunker import ChunkBuilder
from build.faiss_helpers import create_index, train_index, clone_trained_empty
from build.sqlite_store import connect, chunk_rows, INSERT_SQL, finalize_indexes
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            r"configs\selected_config.json"
        ),
    )
    parser.add_argument(
        "--sample-vectors",
